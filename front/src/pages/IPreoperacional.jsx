...
function IPreoperacional () {
  ...
  const filteredPreoperacional = Preoperacional.filter(Preoperacional =>
    Object.values(Preoperacional).some(value =>
      ...
      <div className="container mx-auto px-4 py-4 mt-20">
        <main className="bg-transparent rounded-lg shadow-lg p-6">
          ...
          <span className="text-sm">
            { 
              `Mostrando ${Math.min( filteredPreoperacional.length)} de ${filteredPreoperacional.length} Preoperacionales`}
          </span>
          {/* Inventory Table */}
